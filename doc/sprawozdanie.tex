...
\begin{document}
    ...
    Klasa Solver oraz klasy po niej dziedziczące zawierają logikę odpowiedzalną za rozwiązanie układanki daną metodyką.  Klasa Logger odpowiada za zbieraniu dodatkowych informacji, może być połaczona z klasami rozwiązującymi
        ...
        \begin{table}[!ht]
            ...
            \resizebox{\columnwidth}{!}{
                \begin{tabular}{|l|l|l|l|l|l|}
                    ...
                    A* (hamm)  & 15,000& 530,7& 171,05& 15,00& 10,508\\ \hline
    ...
    % \begin{center}
    % \textbf{Wykresy dla układów z odległością od rozwiązania wynoszącą 1-7}
    %          \hphantom{4}\\
    %          \hphantom{4}\\
    % \end{center}
